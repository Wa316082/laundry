...
<section class="container-fluid mt-5 ">
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('service_category.update', $service_category->id) }}" method="POST" class="row">
                @csrf
                ...
                <div class="col-md-6 col-12 mb-4">
                    ...
                    <input type="details" id="details" name="details" class="form-control"
                        placeholder="Category details"value="{{ old('details',$service_category->details ) }}">
                    @error('details')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
