...
<section class="container-fluid mt-5 ">
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('service.update', $service->id) }}" method="POST" class="row" enctype="multipart/form-data">
                @csrf
                ...
                <div class="col-md-6 col-12 mb-4">
                    ...
                    <input type="details" id="details" name="details" class="form-control"
                        placeholder="SErvice details"value="{{ old('details',  $service->details) }}">
                    @error('details')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="col-md-6 col-12 mb-4">
                    ...
                    <input type="number" step="any" id="price" value="{{ old('price',  $service->price) }}" name="price" class="form-control" placeholder="price">
                    @error('price')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
