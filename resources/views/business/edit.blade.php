...
<section class="container-fluid mt-5 ">
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('business.update', $business->id) }}" method="POST" class="row" enctype="multipart/form-data">
                @csrf
                ...
                <div class="col-md-6 col-12 mb-4">
                    ...
                    <input type="number" step="any" id="business_contact" name="business_contact" class="form-control"
                        placeholder="Business Contact"value="{{ old('business_contact', $business->business_contact) }}">
                ...
                <div class="col-md-6 col-12 mb-4">
                    ...
                    <input type="business_email" id="business_email" name="business_email" class="form-control"
                        placeholder="Business email"value="{{ old('business_email', $business->business_email) }}">
                ...
                <div class="col-md-6 col-12 mb-4">
                    ...
                    <input type="text" id="business_address" name="business_address" class="form-control"
                        placeholder="Business Address"value="{{ old('business_address', $business->business_address) }}">
                ...
                <div class="col-md-6 col-12 mb-4">
                    ...
                    <input type="text" id="business_detail1" name="business_detail1" class="form-control"
                        placeholder="Business Detail Line 1"value="{{ old('business_detail1', $business->business_detail1) }}">
                ...
                <div class="col-md-6 col-12 mb-4">
                    ...
                    <input type="text" id="business_detail2" name="business_detail2" class="form-control"
                        placeholder="Business Detail line 2"value="{{ old('business_detail2', $business->business_detail2) }}">
                ...
                <div class="col-md-6 col-12 mb-4">
                    ...
                    <input type="text" id="business_detail3" name="business_detail3" class="form-control"
                        placeholder="Business Detail3"value="{{ old('business_detail3', $business->business_detail3) }}">
                ...
                <div class="col-md-6 col-12 mb-4">
                    ...
                    <input type="text" id="business_extra1" name="business_extra1" class="form-control"
                        placeholder="Business Extra Line 1"value="{{ old('business_extra1', $business->business_extra1) }}">
                ...
                <div class="col-md-6 col-12 mb-4">
                    ...
                    <input type="text" id="business_extra2" name="business_extra2" class="form-control"
                        placeholder="Business Extra Line 2"value="{{ old('business_extra2', $business->business_extra2) }}">
